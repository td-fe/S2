...
import { buildDrillDownOptions, handleDrillDown } from '@tant/s2-shared';
import type { SpreadSheet, S2Options } from '@tant/s2';
import type { PartDrillDown, ActionIconCallbackParams } from '@tant/s2-shared';
