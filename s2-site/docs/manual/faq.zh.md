...
目前只有 React 版本 `@tant/s2-react` 支持编辑表格，其他版本暂不支持，需参考 [源码](https://github.com/antvis/S2/blob/2d85d5739f5a3a52e92df699a935df93aa2a6a73/packages/s2-react/src/components/sheets/editable-sheet/index.tsx#L10) 自行实现
...
配套的 [分析组件](/docs/manual/basic/analysis/editable-mode)，目前还没有 `@tant/s2-angular` 的开发计划，欢迎社区一起建设 👏🏻.
